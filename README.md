...
[![MCP Tools](https://img.shields.io/badge/MCP_工具-345-orange.svg)](#ai-原生集成)
...
- 宏观治理与 MCP 文档已同步刷新；当日文档快照口径为 `345` 个 MCP 工具
...
- **MCP Server（当前注册 345 个工具）** — 直接接入 Claude、Cursor 或任何支持 MCP 的 AI
...
**345 个 MCP 工具**不是只覆盖几个查询接口，而是横跨宏观、政策、信号、回测、账户、组合、交易、AI 能力目录、终端命令、运行时编排、系统配置等多个系统面向。
