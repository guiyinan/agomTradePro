...
`)}function Ae(e,t=""){return ce(e).emptyStateHint||A(t||e?.summary||"\u5148\u8FD0\u884C\u672C\u5C4F\u4E3B\u4EFB\u52A1\u3002")}function bn(e){const t=ce(e),n=[["\u4E3B\u4EFB\u52A1",t.primaryTask],["\u76EE\u6807\u7ED3\u679C",t.primaryOutcome]],r=mt([t.emptyStateHint,t.nextStepHint]);return[{title:"\u7528\u6237\u4EFB\u52A1",rows:n,body:r}]}function wn(e){return Array.isArray(e?.dashboard_panels)&&e.dashboard_panels.length>0}function le(e){return wn(e)&&String(e?.chrome_mode||"").toLowerCase()==="immersive"}function st(e){if(!e||!e.objective&&!e.decision_output&&!(e.checkpoints||[]).length)return[];const t=[];e.objective&&t.push({label:"\u76EE\u6807",value:A(e.objective)}),e.decision_output&&t.push({label:"\u4EA7\u51FA",value:A(e.decision_output)});const n=(e.checkpoints||[]).map((r,a)=>`${a+1}. ${A(r)}`);return[{title:"\u4E1A\u52A1\u76EE\u6807",rows:t,body:n}]}function ta(e){if(!c.workflowStrip)return;if(x(o.screen?.screen?.key)){c.workflowStrip.hidden=!0,c.workflowStrip.innerHTML="";return}const t=e||{};if(!t.name){c.workflowStrip.hidden=!0,c.workflowStrip.innerHTML="";return}const n=t.previous||{},r=t.next||{},a=w.host?.workflowActionKeys||[],s=(typeof C.getHomeActions=="function"?C.getHomeActions({lastWorkspace:o.lastNonHomeScreen,preferredLane:o.preferredHomeLane}):[]).filter(f=>a.includes(f.key)),l=String(w.host?.workflowActionsLane||""),d=s.length&&l&&Xt({workflow:t})===l?`
            ...
            ${d}
        `,c.workflowStrip.querySelectorAll("[data-workflow-target]").forEach(f=>{f.addEventListener("click",()=>S(f.dataset.workflowTarget))}),c.workflowStrip.querySelectorAll("[data-home-action-key]").forEach(f=>{f.addEventListener("click",()=>ne(f.dataset.homeActionKey))})}function na(){const e=typeof C.getHomeActions=="function"?C.getHomeActions({lastWorkspace:o.lastNonHomeScreen,preferredLane:o.preferredHomeLane,availableActionKeys:new Set((o.screen?.actions||[]).map(t=>String(t.key||"")))}):[];return!Array.isArray(e)||!e.length?"":`
        ...
        `}function Aa(){return Ce(o.lastAction)}function xn(e,t,n={}){const r=An(e.fields||[],n.panel).slice(0,Number(n.panel?.max_rows||12)),a=(e.nested||[]).slice(0,Number(n.panel?.max_rows||12)),s=["tui-semantic-detail",n.compact?"is-compact":"",de(t,"primary_status")?"is-primary-status":"",de(t,"copyable_secret")?"is-copyable-secret":"",de(t,"endpoint_list")?"is-endpoint-list":"",de(t,"multiline_prompt")?"is-multiline-prompt":""].filter(Boolean).join(" "),l=de(t,"primary_status")?`
            ...
            `:"",u=r.filter(h=>Le(h)==="secret"&&W(h.value)),d=r.filter(h=>Le(h)==="copyable"&&W(h.value)),f=r.filter(h=>Le(h)==="multiline"&&W(h.value)),m=r.filter(h=>Le(h)==="metadata"),y=[u.length?La(u):"",d.length?Ta(d):"",m.length?Cn(m):"",f.length?Pa(f):""].filter(Boolean).join(""),g=a.length?`<div class="tui-nested-list">${a.map(h=>`<span>${i(h.label)}: ${i(h.count)} \u884C</span>`).join("")}</div>`:"";return`
            <section class="${s}">
                ${l}
                ${y||V(n.panel||{},"\u6682\u65E0\u6458\u8981\u6570\u636E\u3002")}
                ${g}
            </section>
        `}function W(e){return e!=null&&String(e).trim()!==""&&String(e).trim()!=="-"}function An(e,t){const n=Array.isArray(t?.field_rules)?t.field_rules:[],r=new Map(n.map(a=>[String(a?.label||"").trim(),a]));return(e||[]).flatMap(a=>{const s=r.get(String(a?.label||"").trim());return s?.visible===!1?[]:[{...a,value:Ca(a?.value,s?.format)}]})}function Ca(e,t){const n=String(t||"text").trim();if(n==="money"){if(!W(e))return R(e);const r=Number(e);return Number.isFinite(r)?`${r.toLocaleString("zh-CN",{maximumFractionDigits:2})} \u5143`:R(e)}if(n==="percentage")return vn(e);if(n==="datetime"){const r=Date.parse(String(e||""));return Number.isFinite(r)?new Date(r).toLocaleString("zh-CN",{hour12:!1}):R(e)}return R(e)}function Cn(e){return e.length?`
        ...
        `}function go(e){const a=e.map(g=>g.value),s=Math.max(0,...a),l=Math.min(0,...a),u=s-l||1,d=g=>192-(g-l)/u*164,f=d(0),m=8,y=Math.max(8,(584-m*(e.length-1))/e.length);return`
            <svg class="tui-chart-svg" viewBox="0 0 640 220" aria-hidden="true">
                ...
                ${e.map((g,h)=>{const b=28+h*(y+m),B=d(g.value),M=Math.min(f,B),De=Math.max(2,Math.abs(B-f));return`<rect class="tui-chart-bar" x="${b.toFixed(1)}" y="${M.toFixed(1)}" width="${y.toFixed(1)}" height="${De.toFixed(1)}"></rect>`}).join("")}
            </svg>
        ...
        `,gt(c.main,e.next_steps)}function ge(e){const t=o.screen?.screen||{},n=t.business_context||{};if(!n.decision_output&&!n.objective&&!e?.business_summary)return"";const a=(t.workflow||{}).next||{},s=o.screen&&o.screen.actions||[],l=me(s),u=So(e),f=[["\u5224\u65AD\u4EA7\u51FA",String(e?.business_summary||"").trim()||n.decision_output||n.objective],["\u5F53\u524D\u8BC1\u636E",u]];e?.blocking_reason&&f.push(["\u5F53\u524D\u963B\u65AD",e.blocking_reason]);const m=[];l.operation&&f.push(["\u53EF\u6267\u884C\u64CD\u4F5C",`${l.operation} \u9879\uFF0C\u63D0\u4EA4\u524D\u786E\u8BA4`]);const y=He(s);y.total&&f.push(["\u672C\u5C4F\u8FDB\u5EA6",`${y.completed}/${y.total}`]);const g=xt();return g&&(f.push(["\u672C\u5C4F\u4E0B\u4E00\u9879",g.label]),m.push({command:"next-primary",label:g.label,key:"F6",title:"\u8FD0\u884C\u4E0B\u4E00\u4E3B\u6D41\u7A0B"})),a.label&&(f.push(["\u4E0B\u4E00\u6B65",a.label]),m.push({command:"workflow-next",label:a.label,key:"F4",title:"\u8FDB\u5165\u6D41\u7A0B\u4E0B\u4E00\u5C4F"})),`
