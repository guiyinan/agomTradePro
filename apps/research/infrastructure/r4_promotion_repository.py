...
from apps.research.infrastructure.r4_promotion_repository_queries import (
    R4PromotionRepositoryQueryMixin,
)
...
class DjangoR4PromotionRepository(R4PromotionRepositoryQueryMixin):
