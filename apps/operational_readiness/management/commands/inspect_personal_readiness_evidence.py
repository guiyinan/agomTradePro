    ...
    *,
    ...
    for asset_code, quote in quotes.items():
        ...
        if quote.get("is_stale") is True or (
            freshness_status and freshness_status not in ACCEPTED_DECISION_QUOTE_FRESHNESS_STATUSES
        ):
...
def _load_current_post_evidence_persistence_if_target_matches(
    *,
    ...
    try:
        from apps.operational_readiness.infrastructure import readiness_persistence_status
