...
from apps.operational_readiness.infrastructure.readiness_status_evidence import (
...
from apps.operational_readiness.management.commands.setup_personal_readiness_daily import (
    DEFAULT_TASK_KWARGS,
    TASK_NAME,
    TASK_PATH,
)
