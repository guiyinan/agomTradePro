...
RUNTIME_CONFIG_CENTER_SCREEN: dict[str, Any] = {
    ...
    "dashboard_panels": [
        {
            "key": "runtime-config-control-plane",
            "title": "零、运行配置与容量策略",
            "kind": "detail",
            "action_key": "operator.governance.config_center_summary",
            "layout_area": "control_plane",
            "target_screen": "api-library.config-center",
            "empty_message": "暂无已激活的运行配置或容量策略；请先显式初始化并激活 profile。",
            "error_message": "运行配置治理摘要读取失败，决策入口保持阻断。",
            "stale_message": "运行配置可能已变化，请刷新后再操作。",
            "user_priority": "p0",
