...
class CommandParameter:
    ...
    def to_dict(self) -> dict[str, Any]:
        """Serialize this parameter without exposing mutable internal lists."""
        return {
            "name": self.name,
    ...
    def from_dict(cls, data: dict[str, Any]) -> "CommandParameter":
        """Build a parameter from its JSON-compatible persistence payload."""
        return cls(
            name=data["name"],
...
class TerminalCommand:
    ...
    def to_dict(self) -> dict[str, Any]:
        """Serialize this command without exposing mutable internal lists."""
        return {
            "id": self.id,
            "name": self.name,
            "description": self.description,
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "TerminalCommand":
        """Build a command from its JSON-compatible persistence payload."""
        ...
        return cls(
            ...
            risk_level=(
                TerminalRiskLevel(risk_level_val) if risk_level_val else TerminalRiskLevel.READ
            ),
