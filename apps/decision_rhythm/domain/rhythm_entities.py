"""Decision rhythm quota, cooldown, request, and response entities."""
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "estimated_execution_at": (
                self.estimated_execution_at.isoformat() if self.estimated_execution_at else None
            ),
...
class RhythmConfig:
    ...
    priority_weights: dict[DecisionPriority, float] = field(
