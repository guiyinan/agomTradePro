...
urlpatterns = [
    ...
    path("api/decision/workspace/plans/generate/", decision_rhythm_api_views.TransitionPlanGenerateView.as_view(), name="decision-workspace-plan-generate"),
    path("api/decision/workspace/plans/<str:plan_id>/", decision_rhythm_api_views.TransitionPlanDetailView.as_view(), name="decision-workspace-plan-detail"),
    path("api/decision/workspace/plans/<str:plan_id>/update/", decision_rhythm_api_views.TransitionPlanUpdateView.as_view(), name="decision-workspace-plan-update"),
    path("api/decision/workspace/invalidation/template/", decision_rhythm_api_views.InvalidationTemplateView.as_view(), name="decision-workspace-invalidation-template"),
    path("api/decision/workspace/invalidation/ai-draft/", decision_rhythm_api_views.InvalidationAIDraftView.as_view(), name="decision-workspace-invalidation-ai-draft"),
