...
def audit_home_redirect(request: HttpRequest) -> HttpResponseRedirect:
...
urlpatterns = [
    ...
    path(
        ...
        views.IndicatorPerformancePageView.as_view(),
        name="indicator_performance",
    ),
    path(
        "threshold-validation/",
        views.ThresholdValidationPageView.as_view(),
    ...
    path(
        "operation-logs/", views.OperationLogsAdminPageView.as_view(), name="operation_logs_admin"
    ),
    path("my-logs/", views.MyOperationLogsPageView.as_view(), name="my_operation_logs"),
    path(
        "decision-traces/",
        views.DecisionTracesAdminPageView.as_view(),
        name="decision_traces_admin",
    ),
    path(
        "my-decision-traces/", views.MyDecisionTracesPageView.as_view(), name="my_decision_traces"
    ),
]
