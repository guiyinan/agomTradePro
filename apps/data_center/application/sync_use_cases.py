...
if TYPE_CHECKING:
    ...
    from .sync_valuation_sector_use_cases import (
...
def __getattr__(name: str) -> object:
    ...
    if name in {"SyncSectorMembershipUseCase", "SyncValuationUseCase"}:
        from . import sync_valuation_sector_use_cases

        return getattr(sync_valuation_sector_use_cases, name)
