"""Django persistence and Equity adapter for evaluation actual evidence."""
...
class DjangoEvaluationActualEvidenceProvider:
    """Read-only adapter implementing Equity's exact actual provider port."""

    __slots__ = ("_repository",)

    def __init__(self, repository: DjangoEvaluationActualRepository) -> None:
    ...
    def get_actual_manifest(
        ...
        *,
        ...
        """Return an Equity snapshot projection from one strict owner receipt."""
