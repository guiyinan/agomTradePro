        ...
        return Response(
            {
                "endpoints": {
                    ...
                    "pit_manifests": "/api/data-center/pit-manifests/",
...
urlpatterns = [
    ...
    path("pit-manifests/", pit_manifest_list_create, name="dc-pit-manifest-list"),
    path(
        "pit-manifests/<str:manifest_id>/",
        pit_manifest_detail,
        name="dc-pit-manifest-detail",
    ),
