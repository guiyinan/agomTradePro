...
INDICATORS = [
    ...
    ("CN_PMI",            "PMI 制造业采购经理指数",             "Manufacturing PMI",         "%",   "M", "growth"),
    ("CN_NON_MAN_PMI",    "非制造业PMI",                        "Non-Manufacturing PMI",     "%",   "M", "growth"),
    ...
    ("CN_CPI",            "CPI 居民消费价格指数",               "CPI",                       "%",   "M", "inflation"),
    ...
    ("CN_PPI",            "PPI 工业生产者出厂价格指数",         "PPI",                       "%",   "M", "inflation"),
    ...
    ("CN_M2",             "M2 广义货币供应量",                  "M2 Broad Money",           "亿元", "M", "money"),
