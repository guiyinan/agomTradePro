...
get_predefined_chains = _command_module.get_predefined_chains
get_predefined_templates = _command_module.get_predefined_templates
DjangoChainRepository = _command_module.DjangoChainRepository
DjangoPromptRepository = _command_module.DjangoPromptRepository
