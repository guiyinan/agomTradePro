...
from apps.dashboard.application.dashboard_data_contracts import DashboardData as DashboardData
from apps.dashboard.application.dashboard_data_contracts import (
    _AllocationAssetClassValue,
    _AllocationPosition,
    _DashboardOverviewRepository,
