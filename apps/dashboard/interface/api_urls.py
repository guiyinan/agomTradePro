    ...
    return JsonResponse(
        {
            "endpoints": {
                ...
                "auto_advisor_query": "/api/dashboard/auto-advisor-query/",
                "auto_advisor_weekly_report": "/api/dashboard/auto-advisor-weekly-report/",
                "auto_advisor_weekly_report_history": "/api/dashboard/auto-advisor-weekly-report-history/",
                "auto_advisor_notifications": "/api/dashboard/auto-advisor-notifications/",
...
urlpatterns = [
    ...
    path(
        ...
        api_v1_views.auto_advisor_console,
        name="auto_advisor_console",
    ),
    path(
        "auto-advisor-query/",
        api_v1_views.auto_advisor_query,
        name="auto_advisor_query",
    ),
    path(
        "auto-advisor-weekly-report/",
        api_v1_views.auto_advisor_weekly_report,
        name="auto_advisor_weekly_report",
    ),
    path(
        "auto-advisor-weekly-report-history/",
        api_v1_views.auto_advisor_weekly_report_history,
        name="auto_advisor_weekly_report_history",
    ),
    path(
        "auto-advisor-notifications/",
        api_v1_views.auto_advisor_notifications,
        name="auto_advisor_notifications",
    ),
