...
urlpatterns = [
    ...
    path("orders/<uuid:client_order_id>/", BrokerExecutionOrderDetailView.as_view(), name="order-detail"),
    path("orders/<uuid:client_order_id>/<str:action>/", BrokerExecutionOrderActionView.as_view(), name="order-action"),
    ...
    path("reconciliations/<int:run_id>/resolve/", BrokerExecutionReconciliationResolveView.as_view(), name="resolve-reconciliation"),
    ...
    path("credentials/rotate/", BrokerExecutionCredentialRotateView.as_view(), name="credential-rotate"),
    path("credentials/<uuid:credential_id>/revoke/", BrokerExecutionCredentialRevokeView.as_view(), name="credential-revoke"),
    ...
    path("agent/v1/commands/complete/", AgentCommandCompleteView.as_view(), name="agent-command-complete"),
]
