...
DEFAULT_RUNTIME_DEFINITIONS: tuple[RuntimeConfigDefinition, ...] = (
    ...
    RuntimeConfigDefinition(
        key="account.creation_evidence.settings",
        namespace="account",
        owner_app="account",
        value_type=RuntimeValueType.TYPED_JSON,
        criticality=RuntimeConfigCriticality.CRITICAL,
        reload_mode=RuntimeConfigReloadMode.NEXT_TASK,
        description="Complete recorder bindings and TTL for Account creation evidence.",
        user_impact="Binds the creation-evidence chain to one versioned runtime snapshot.",
    ),
    RuntimeConfigDefinition(
        key="account.single_owner_policy.publication_settings",
        namespace="account",
        owner_app="account",
        value_type=RuntimeValueType.TYPED_JSON,
        criticality=RuntimeConfigCriticality.CRITICAL,
        reload_mode=RuntimeConfigReloadMode.NEXT_TASK,
        description="Explicit owner declaration reference and TTL for single-owner policy publication.",
        user_impact="Supplies policy publication inputs without authenticating an owner or granting access.",
    ),
    RuntimeConfigDefinition(
        key="account.single_owner_policy.authorization_source",
        namespace="account",
        owner_app="account",
        value_type=RuntimeValueType.TYPED_JSON,
        criticality=RuntimeConfigCriticality.NORMAL,
        reload_mode=RuntimeConfigReloadMode.NEXT_TASK,
        description="Exact declaration bytes and explicit digest for policy publication.",
        user_impact="Provides declaration evidence; absence blocks publication without granting access.",
    ),
    RuntimeConfigDefinition(
