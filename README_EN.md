...
- Macro-governance and MCP docs are now aligned with the current local snapshot of `358` registered MCP tools
...
- **MCP Server (358 registered tools)** — plug directly into Claude, Cursor, or any MCP-compatible AI
...
**358 MCP tools** do not just expose a few query endpoints. They span macro, policy, signals, backtesting, accounts, portfolios, trading flows, AI capability routing, terminal commands, runtime orchestration, and system-level operations.
