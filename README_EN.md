...
[![MCP Tools](https://img.shields.io/badge/MCP_tools-309-orange.svg)](#ai-native-integration)
...
- **MCP Server (309 registered tools)** — plug directly into Claude, Cursor, or any MCP-compatible AI
...
**309 MCP tools** do not just expose a few query endpoints. They span macro, policy, signals, backtesting, accounts, portfolios, trading flows, AI capability routing, terminal commands, runtime orchestration, and system-level operations.
...
309   MCP tools (current local registration snapshot)
