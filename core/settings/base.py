...
EQUITY_VALUATION_SYNC_TASK_TIMEOUT = env.int(
    "EQUITY_VALUATION_SYNC_TASK_TIMEOUT", default=1800
)  # 30 分钟
EQUITY_VALUATION_SYNC_TASK_SOFT_TIMEOUT = env.int(
    "EQUITY_VALUATION_SYNC_TASK_SOFT_TIMEOUT", default=1700
)
...
EQUITY_VALUATION_SCAN_TASK_TIMEOUT = env.int(
    "EQUITY_VALUATION_SCAN_TASK_TIMEOUT", default=2400
)  # 40 分钟
EQUITY_VALUATION_SCAN_TASK_SOFT_TIMEOUT = env.int(
    "EQUITY_VALUATION_SCAN_TASK_SOFT_TIMEOUT", default=2300
)
