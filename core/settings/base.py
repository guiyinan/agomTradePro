...
EQUITY_VALUATION_SYNC_TASK_TIMEOUT = env.int('EQUITY_VALUATION_SYNC_TASK_TIMEOUT', default=1800)  # 30 分钟
EQUITY_VALUATION_SYNC_TASK_SOFT_TIMEOUT = env.int('EQUITY_VALUATION_SYNC_TASK_SOFT_TIMEOUT', default=1700)

EQUITY_VALUATION_VALIDATE_TASK_TIMEOUT = env.int('EQUITY_VALUATION_VALIDATE_TASK_TIMEOUT', default=600)  # 10 分钟
EQUITY_VALUATION_VALIDATE_TASK_SOFT_TIMEOUT = env.int('EQUITY_VALUATION_VALIDATE_TASK_SOFT_TIMEOUT', default=570)

EQUITY_VALUATION_SCAN_TASK_TIMEOUT = env.int('EQUITY_VALUATION_SCAN_TASK_TIMEOUT', default=2400)  # 40 分钟
EQUITY_VALUATION_SCAN_TASK_SOFT_TIMEOUT = env.int('EQUITY_VALUATION_SCAN_TASK_SOFT_TIMEOUT', default=2300)

# Equity 估值修复默认参数
EQUITY_VALUATION_DEFAULT_LOOKBACK_DAYS = env.int('EQUITY_VALUATION_DEFAULT_LOOKBACK_DAYS', default=756)
EQUITY_VALUATION_SCAN_BATCH_LIMIT = env.int('EQUITY_VALUATION_SCAN_BATCH_LIMIT', default=0)  # 0 = 无限制
