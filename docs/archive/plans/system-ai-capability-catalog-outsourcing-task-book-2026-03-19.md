...
> 归档状态（2026-08-12）：代码与自动化验收已完成。Capability Catalog 核心模型、MCP/API 自动采集、同步、检索/决策/分发、权限确认、管理面和审计链均已落地；2026-08-12 定向复核中 Capability Catalog 与 Web Chat 相关测试 `759 passed`。本文仅保留为历史实施规格。
