...
- 宏观治理白名单已按 `2026-05-04` 的真实抓取冒烟结果扩到 52 个可自动同步指标；新增放开的包括 PMI/非制造业 PMI、SHIBOR、LPR、RRR、新增信贷、人民币存贷款、国债收益率、运价指数、PMI 分项等，页面“全部刷新可抓取指标”会覆盖这批已验证可回数的序列
