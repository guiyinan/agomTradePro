...
client.account.create_trading_cost_config(portfolio_id, min_commission, commission_rate, stamp_duty_rate, transfer_fee_rate) -> dict
...
| `min_commission` | `float` | required | 最低佣金（元，按券商配置显式提供） |
