...
**需求**:
- [ ] 代码编辑器集成（CodeMirror 或 Monaco Editor）
  - [ ] Python 语法高亮
  - [ ] 行号显示
  - [ ] 代码折叠
  - [ ] 自动缩进
- [ ] 脚本 API 文档集成
  - [ ] 内置函数列表（get_macro_indicator、get_regime、get_asset_pool等）
  - [ ] 函数参数说明
  - [ ] 使用示例
- [ ] 脚本测试和调试
  - [ ] 沙箱内执行脚本
...
#### 6. 详细执行日志
**位置**: `core/templates/strategy/components/execution_log.html`
