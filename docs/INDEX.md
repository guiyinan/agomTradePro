...
| [production-recovery-and-regression-remediation-2026-09-24.md](plans/production-recovery-and-regression-remediation-2026-09-24.md) | **行情、正式发布、决策运行时、Alpha、API/SDK/MCP、只读工作台与生产预演的联合整改计划** | 执行中；十项整改与五类永久防回归工作已分阶段建账，S6 候选门禁仍在补齐负向契约和不可绕过编排，真实 provider、正式发布及普通用户生产联合复验未完成 |
