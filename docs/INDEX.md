...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：M0 已冻结外部写面、10 个 Transition Plan writer、41 个显式输出及 16 个 Broker 动态 query/GET 面；legacy plan writer 在 canonical 模式 fail-closed，默认切换仍关闭；M1 核心账本/read/lifecycle/Risk composition 与首批 adapters 已完成 |
