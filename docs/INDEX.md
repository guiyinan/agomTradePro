...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：Portfolio submit、Advisor draft 与 Broker四节点硬阻断；Broker current-data=49和四类动态读已收窄；Broker execution scope、Portfolio canonical-v1 integrity/inactive approval、Risk order authorization三层Domain合同已冻结，但均未激活；尚缺Risk/Portfolio ledger/provider、Broker issuer/四节点重验与生产证明，MCP integrated=0 |
