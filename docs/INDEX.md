...
| [web-to-tui-migration-plan-2026-07-25.md](plans/web-to-tui-migration-plan-2026-07-25.md) | **Web 界面 → TUI 整体迁移计划（M0-M5，195 模板去向矩阵 / 图表样板 / web 保留清单）** | 实施中；M0-M4 完成；M5 旧 UAT/cleanup/rollback 因未绑定最终候选已改判 FAIL，观察未开始 |
...
| [web-to-tui-m5-readiness-2026-07-27.md](plans/web-to-tui-m5-readiness-2026-07-27.md) | **Web → TUI M5 Readiness（14 日兼容期、UAT、telemetry 与回滚演练门禁）** | ⛔ 当前 DENY；candidate/部署证明与 M5-B 每波 cleanup guard 已加固；recorders、真实候选与观察窗口待补 |
...
| [web-to-tui-m5-rollback-drill-evidence-2026-07-27.md](plans/web-to-tui-m5-rollback-drill-evidence-2026-07-27.md) | **Web → TUI M5 回滚演练（隔离 reverse/restore、旧 graph 兼容与 registry 回滚发布）** | 历史演练记录；当前 baseline 已漂移且未绑定最终候选，当前 gate FAIL |
...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：M0 freeze 已接 CI，M1 Domain/persistence/read API/lifecycle/summary/Risk approval 与 Research↔Risk read composition 首批已完成；人工审批写入面/各 App adapters 待续 |
