...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：Portfolio submit、Advisor draft 与 Broker四节点硬阻断；Broker current-data=49和四类动态读已收窄；三层inactive Domain合同与Risk ID-only workflow已完成，并已修正跨时钟first-winner replay、persisted subject核验和superseded-head复活；仍缺生产provider/ledger、Broker issuer/四节点重验，MCP integrated=0 |
