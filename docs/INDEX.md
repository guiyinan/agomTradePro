...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：M0 已冻结外部写面、10 个 Transition Plan writer、65 个显式输出、18 个动态面及 18 个 MCP P0 发布面；真实 Portfolio canonical TransitionPlan/OrderDraft 已纳入未治理分母；Terminal result bridge 与 6 个 Broker native read 已暂停（disabled=7、integrated=0）；Strategy preview 恒 display-only；M1 首批 adapters 均未授予执行权限 |
