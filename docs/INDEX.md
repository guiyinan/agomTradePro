...
- 2026-09-03 新增 Web→TUI candidate consistency 计划/索引护栏：单测从 registry/cutover binding 读取当前 commit/version，并校验 `docs/plans/README.md` 的 M5 行与本索引的 M5 readiness 行同步包含该绑定；静态 focused `1 passed`，不改变生产候选或门禁。
