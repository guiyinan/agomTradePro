...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：三层inactive Domain、Risk ID-only workflow和append-only ledger已完成；first-winner与current-head已修复跨时钟replay、persisted subject、superseded/head selector篡改及完整链验证；0008仍缺Django/PG runtime，生产provider、Portfolio ledger、Broker issuer/四节点重验未完成，MCP integrated=0 |
