...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：Portfolio submit、Advisor draft 与 Broker四节点硬阻断；Broker current-data=49和四类动态读已收窄；Broker scope、Portfolio inactive approval与Risk order authorization Domain合同已冻结，Risk ID-only register/approve/exact/PIT Application协议已完成；仍缺生产policy/scope provider、Risk/Portfolio ledger、Broker issuer/四节点重验，MCP integrated=0 |
