...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：M0 owner/write/output freeze、M1 Domain/persistence/read API/Operator Spec lifecycle 首批已完成；真实 Risk provider/adapters 待续 |
