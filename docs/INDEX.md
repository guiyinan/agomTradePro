...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：M0 已冻结外部写面、10 个 Transition Plan writer、54 个显式输出及 18 个动态面；R1–R6 新增面仍是 research-only、未接入 Evidence；Transition Plan 同表 family/cross-family 首批防线已完成但默认切换仍关闭；M1 核心账本与首批 adapters 已完成 |
