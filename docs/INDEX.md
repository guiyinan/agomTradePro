...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：M0 owner/write/output freeze、M1 Domain 与 append-only persistence 首批已完成；统一 Evidence 接入及 API/adapters 待续 |
