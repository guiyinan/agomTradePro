...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：M0 freeze 已接 CI，M1 Domain/persistence/read API/lifecycle/summary/Risk approval provider 首批已完成；composition/adapters 待续 |
