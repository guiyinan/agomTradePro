...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：M0 已冻结外部写面、9 个 Transition Plan writer、41 个显式输出及 16 个 Broker 动态 query/GET 面；M1 核心账本/read/lifecycle/Risk composition、人工审批写入面代码与 Quote/Broker approval adapters 已完成；完整 runtime/其余 adapters 待续 |
