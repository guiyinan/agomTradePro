...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：M0 已冻结外部写面、10 个 Transition Plan writer、54 个显式输出、18 个动态面及 18 个 MCP P0 发布面；Terminal result bridge 与 6 个 Broker native read 已暂停（MCP disabled=7、integrated=0）；Transition Plan 同表防线已完成但默认切换仍关闭；M1 核心账本与首批 adapters 已完成 |
