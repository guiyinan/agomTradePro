...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：Portfolio submit、Advisor draft 与 Broker四节点硬阻断；三层inactive Domain合同、Risk ID-only workflow/current-head修正和append-only ledger/codec/repository已完成；0008为zero-seed但Django/PG runtime未验证，仍缺生产policy/scope provider、Portfolio ledger、Broker issuer/四节点重验，MCP integrated=0 |
