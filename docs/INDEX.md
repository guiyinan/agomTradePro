...
| [evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md](plans/evidence-governance-and-decision-hard-gate-remediation-plan-2026-08-12.md) | **证据治理与决策硬闸改造计划** | 第一期 P0：已冻结 10 个 Transition writer、65 个显式/18 个动态输出及 18 个 MCP P0 read 面；Portfolio submit、Advisor draft 与 Broker四节点均硬阻断；Broker current-data=49和四类动态读已收窄，execution authorization schema已冻结；Portfolio canonical-v1 Domain hash/篡改重验与inactive approval合同已完成，仍缺Portfolio ledger/provider、Risk owner receipt与Broker四节点重验，MCP integrated=0 |
