...
| R2 市场结构与投资者资金流 | `blocked` | 已有 taxonomy/measure/proxy/PIT membership、版本化 calendar/coverage、Publication/Promotion、两周期 explanatory trial/monitoring合同与 `0016` persistence；仍需获批定义、真实 calendar、两个周期真实 PIT 覆盖、owner authorization、Audit outcome 与 concrete owner providers | [R1/R2](strategy-research-r1-r2-readiness-plan-2026-08-05.md) |
...
| R5 固收相对价值与久期 | `blocked` | 已有定价/久期/曲线/信用、PIT 分位、评级迁移、流动性分解、signed curve portfolio/capacity、fixed_income/Portfolio/Research append-only owner ledgers、exact query/cross-owner UoW、Promotion/retire/rollback及monitoring Phase A+B persistence；仍需canonical monitoring owner composition、真实 Publication、PIT/OOS、券级事实、容量/借券、authorization、外部对账和下游验收 | [R5—R8](strategy-research-r5-r8-readiness-and-staged-delivery-2026-08-05.md) |
...
| R7 情景概率校准 | `blocked` | 已有 source-separated Brier/分箱、PIT 类比、逐期路径证据、reminder/sample-policy/result/lifecycle append-only ledger、审计 snapshot、无状态 production façade、post-promotion monitoring Phase A+B及独立family `stack[-2]` rollback Phase A+B ledger；仍需完整 outcome 历史、真实 Risk Center/Forecast Ledger owner source、approved policy及合格 family/result authorization | [R5—R8](strategy-research-r5-r8-readiness-and-staged-delivery-2026-08-05.md) |
