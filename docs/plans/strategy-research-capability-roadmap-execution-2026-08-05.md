...
| R4 宏观敞口与风险平价 | `blocked` | 已有暴露/风险贡献候选、typed rolling/Regime 汇总、三方法同窗比较、exact R3 attestation、append-only result ledger/query 与 covariance condition/rank/coverage diagnostics；仍需 Research Promotion/retirement/rollback lifecycle、真实 R3 晋级和 canonical inputs | [R3/R4](macro-factor-r3-r4-readiness-and-staged-delivery-2026-08-05.md) |
