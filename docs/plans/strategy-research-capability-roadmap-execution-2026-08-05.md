...
| R5 固收相对价值与久期 | `blocked` | 已有定价/久期/曲线/信用、PIT 分位、评级迁移、流动性分解、signed curve portfolio/capacity 与 ID-only composite 软件合同；仍需 append-only persistence/concrete providers/UoW/Promotion，以及真实 Publication、PIT 历史、券级事实、容量/借券和外部对账 | [R5—R8](strategy-research-r5-r8-readiness-and-staged-delivery-2026-08-05.md) |
