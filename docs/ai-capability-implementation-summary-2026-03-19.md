...
| 端点 | 方法 | 说明 | 认证 |
|------|------|------|------|
| `/api/account/accounts/` | GET/POST | 统一账户列表/创建 | 需要 |
| `/api/account/accounts/{id}/` | GET | 统一账户详情 | 需要 |
| `/api/account/accounts/{id}/positions/` | GET | 持仓列表 | 需要 |
| `/api/account/accounts/{id}/trades/` | GET | 交易记录 | 需要 |
| `/api/account/accounts/{id}/performance/` | GET | 账户绩效 | 需要 |
...
| 日期 | 版本 | 更新内容 |
|------|------|----------|
| 2026-03-22 | V3.6 | 新增 ai_capability 模块，更新模块数量(32→33) |
