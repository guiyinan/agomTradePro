...
@pytest.mark.parametrize(
    ...
    [
        ...
        (lambda c: c.events.query({"event_type": "test"}), "POST", "/api/events/query/", {"json": {"event_type": "test"}}),
        ...
        (lambda c: c.filter.list_filters(), "GET", "/api/filter/"),
        (lambda c: c.filter.get_filter(11), "GET", "/api/filter/11/"),
