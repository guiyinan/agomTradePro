...
@pytest.mark.parametrize(
    ...
    [
        ...
        (lambda c: c.pulse.get_history(limit=5), "GET", "/api/pulse/history/", {"params": {"limit": 5}}),
        ...
        (lambda c: c.rotation.import_default_assets(), "POST", "/api/rotation/assets/import-defaults/", {"json": {}}),
        (lambda c: c.rotation.export_assets("csv"), "GET", "/api/rotation/assets/export/", {"params": {"format": "csv"}}),
