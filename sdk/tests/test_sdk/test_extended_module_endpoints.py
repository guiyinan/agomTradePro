...
@pytest.mark.parametrize(
    ...
    [
        ...
        (lambda c: c.ai_provider.create_provider({"name": "p1"}), "POST", "/api/ai/providers/", {"json": {"name": "p1"}}),
        (lambda c: c.ai_provider.update_provider(7, {"name": "p2"}), "PATCH", "/api/ai/providers/7/", {"json": {"name": "p2"}}),
        (lambda c: c.ai_provider.delete_provider(7), "DELETE", "/api/ai/providers/7/"),
        (lambda c: c.ai_provider.toggle_provider(7), "POST", "/api/ai/providers/7/toggle_active/", {"json": {}}),
        (lambda c: c.ai_provider.provider_usage_stats(7), "GET", "/api/ai/providers/7/usage_stats/"),
        (lambda c: c.ai_provider.overall_stats(), "GET", "/api/ai/providers/overall_stats/"),
        (lambda c: c.ai_provider.list_usage_logs(provider_id=7, status="success"), "GET", "/api/ai/logs/", {"params": {"provider": 7, "status": "success"}}),
        (lambda c: c.prompt.list_templates(), "GET", "/api/prompt/templates/"),
        (lambda c: c.prompt.get_template(3), "GET", "/api/prompt/templates/3/"),
        (lambda c: c.prompt.create_template({"name": "t1"}), "POST", "/api/prompt/templates/", {"json": {"name": "t1"}}),
        (lambda c: c.prompt.update_template(3, {"name": "t2"}), "PATCH", "/api/prompt/templates/3/", {"json": {"name": "t2"}}),
        (lambda c: c.prompt.delete_template(3), "DELETE", "/api/prompt/templates/3/"),
        (lambda c: c.prompt.list_chains(), "GET", "/api/prompt/chains/"),
        (lambda c: c.prompt.create_chain({"name": "c1"}), "POST", "/api/prompt/chains/", {"json": {"name": "c1"}}),
        (lambda c: c.prompt.list_logs(), "GET", "/api/prompt/logs/"),
        (lambda c: c.prompt.chat({"messages": []}), "POST", "/api/prompt/chat"),
        (lambda c: c.prompt.generate_report({"template_id": 1}), "POST", "/api/prompt/reports/generate", {"json": {"template_id": 1}}),
        (lambda c: c.prompt.generate_signal({"template_id": 1}), "POST", "/api/prompt/signals/generate", {"json": {"template_id": 1}}),
        ...
        (lambda c: c.events.query({"event_type": "test"}), "GET", "/api/events/query/", {"params": {"event_type": "test"}}),
        (lambda c: c.events.metrics(), "GET", "/api/events/metrics/"),
        (lambda c: c.events.replay({"event_ids": [1]}), "POST", "/api/events/replay/", {"json": {"event_ids": [1]}}),
        ...
        (lambda c: c.decision_rhythm.summary({"days": 7}), "GET", "/api/decision-rhythm/summary/", {"params": {"days": 7}}),
        ...
        (lambda c: c.alpha_trigger.performance({"days": 30}), "GET", "/api/alpha-triggers/performance/", {"params": {"days": 30}}),
        ...
        (lambda c: c.strategy.bind_portfolio_strategy(1, 12), "POST", "/api/strategy/bind-strategy/", {"json": {"portfolio_id": 1, "strategy_id": 12}}),
        (lambda c: c.strategy.unbind_portfolio_strategy(1), "POST", "/api/strategy/unbind-strategy/", {"json": {"portfolio_id": 1}}),
        ...
        (lambda c: c.dashboard.alpha_provider_status(), "GET", "/api/dashboard/alpha/provider-status/"),
        ...
        (lambda c: c.asset_analysis.pool_summary({"asset_type": "equity"}), "GET", "/api/asset-analysis/pool-summary/", {"params": {"asset_type": "equity"}}),
        ...
        (lambda c: c.sentiment.get_index({"window_days": 7}), "GET", "/api/sentiment/index/", {"params": {"window_days": 7}}),
        (lambda c: c.sentiment.index_range(), "GET", "/api/sentiment/index/range/"),
        (lambda c: c.sentiment.index_range({"start_date": "2026-01-01"}), "GET", "/api/sentiment/index/range/", {"params": {"start_date": "2026-01-01"}}),
        (lambda c: c.sentiment.index_recent(), "GET", "/api/sentiment/index/recent/"),
        (lambda c: c.sentiment.index_recent({"limit": 10}), "GET", "/api/sentiment/index/recent/", {"params": {"limit": 10}}),
        ...
        (lambda c: c.task_monitor.statistics(task_name="sync_equity_valuation_task"), "GET", "/api/system/statistics/", {"params": {"task_name": "sync_equity_valuation_task"}}),
