...
class TestDecisionApprovedHandler:
    ...
    def test_handle_does_not_raise_on_error(self):
        ...
        # Mock 抛出异常
        with patch("apps.alpha_trigger.infrastructure.models.AlphaCandidateModel") as mock_model:
...
class TestDecisionExecutedHandler:
    ...
    def test_handle_updates_execution_status(self):
        ...
        mock_candidate_repo.update_status_to_executed.assert_called_once_with("candidate_123")
