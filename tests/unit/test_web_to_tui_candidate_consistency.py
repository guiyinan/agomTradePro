...
PREFLIGHT_PATH = (
    ROOT / "docs" / "deployment" / "web-to-tui-deployment-preflight-20260816151607.json"
)
...
def test_current_candidate_identity_is_consistent_across_registry_and_evidence() -> None:
    ...
    readiness_current = readiness.split("### 2026-08-16 15:34 当前候选部署复核", 1)[1]
    deployment_current = deployment.split("## 2026-08-16 15:34 当前候选部署与观测", 1)[1]
