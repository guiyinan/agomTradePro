...
OWNER_MODULES = (
    ...
    "apps.account.infrastructure.account_owner_assignment_evidence_v4_models",
    ...
    "apps.account.infrastructure.account_owner_assignment_provenance_receipt_v4_models",
    "apps.account.infrastructure.account_owner_assignment_v5_models",
    ...
    "apps.account.infrastructure.canonical_account_ownership_reobservation_v1_models",
    ...
    "apps.account.infrastructure.single_owner_authority_policy_v1_models",
    "apps.account.infrastructure.owner_tenant_authority_v2_models",
    "apps.account.infrastructure.owner_tenant_authority_v3_models",
